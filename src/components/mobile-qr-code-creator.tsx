    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="flex flex-col items-start space-y-4 md:w-auto w-full order-first lg:order-last">
        <Card className="sticky top-0 z-10 relative flex flex-col items-center p-4 md:w-auto w-full">
              ...
              onCheckedChange={async (checked) => {
                ...
                if (checked) {
                  ...
                  try {
                    ...
                    // Clear loading state and interval after update
                  ...
                  // When disabling scanTracking, clear loading and interval
                  if (intervalRef.current) {
                    clearInterval(intervalRef.current);
                    intervalRef.current = null;
                  }
          ...
          <div className="w-64 h-64 flex items-center justify-center relative" ref={previewRef}>
            <QrPreview
              data={qrString}
