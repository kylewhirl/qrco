...
export function RetailDigitalLinkBuilder() {
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)]">
      <Card className="overflow-hidden rounded-[28px] border-border/80 bg-card shadow-[0_24px_64px_-52px_var(--foreground)]">
        ...
        <CardContent className="space-y-7 p-5 sm:p-7">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <Button
              ...
              disabled={creating}
              className="h-12 rounded-xl bg-[var(--brand-blue)] px-6 font-bold text-white hover:bg-[var(--brand-blue)]/90"
            >
      ...
      <div className="space-y-6">
        <Card className="overflow-hidden rounded-[28px] border-border/80 shadow-[0_24px_64px_-52px_var(--foreground)] xl:sticky xl:top-6">
